...
<h2 class="text-center mb-4">Thanh toan</h2>
...
<option value="cod" <?php echo $selectedMethod === 'cod' ? 'selected' : ''; ?>>COD - Thanh toan khi nhan hang</option>
...
<button type="submit" class="btn btn-success w-100">Dat hang</button>
</form>
</div>
</div>
<?php } ?>
